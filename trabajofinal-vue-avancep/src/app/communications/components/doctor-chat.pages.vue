  ...
  data() {
    return {
      messages: [
        ...
        { id: 2, text: "Hola, todo bien ¿y tú?", sender: 'other' },
        { id: 3, text: "¡Genial! No olvides de la cita que tenemos mañana a las 8:00pm!!.", sender: 'user' },
        { id: 3, text: "Puntual..", sender: 'user' },
        { id: 2, text: "Okey", sender: 'other' },
